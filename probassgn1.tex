...
\begin{align*}
 ...
 (\vec{B} + k(\vec{C}-\vec{B})- \vec{I})  \cdot (\vec{B} + k(\vec{C}-\vec{B})- \vec{I}) &= r^2 
\end{align*}
...
So on substituting this value in (1), we get the point D3 \\
$D3 = \frac{1}{\sqrt{74}+\sqrt{32}+\sqrt{122}}\myvec{{-366\sqrt{74}-406\sqrt{122}-488\sqrt{32}}\\{-610\sqrt{74}+732\sqrt{32}-170\sqrt{122}}}$
