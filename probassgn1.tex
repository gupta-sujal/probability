...
So on substituting this value in (1), we get the point $D_{3}$ \\
$D_{3} = \frac{1}{\sqrt{74}+\sqrt{32}+\sqrt{122}}\myvec{{-366\sqrt{74}-406\sqrt{122}-488\sqrt{32}}\\{-610\sqrt{74}+732\sqrt{32}-170\sqrt{122}}}$
