...
\begin{align}
 &\implies \vec{x} = \vec{B} + k\brak{\vec{m}}\\
 &\implies \norm{\ \vec{x} - \vec{I}\ }^2 = r^2 
\end{align}

Substituting the value of $ \vec{x} $ from (8) in (9)
\begin{align}
  &\implies\norm{ \vec{B} + k\brak{\vec{m}}- \vec{I} }^2 = r^2 \\
  &\implies\sbrak{\vec{B} + k\brak{\vec{m}}- \vec{I}}^{\top} \sbrak{\vec{B} + k\brak{\vec{m}}- \vec{I}} = r^2 
\end{align}
...
\end{split}\\
\begin{split}
&={\sbrak{2\myvec{1&-11}\myvec{-4+1.47756217\\6+0.79495069}}}^2 \\&\qquad-4[122][2.8151+52-2(1.140544)\\&\qquad-3.59820]
\end{split}\\
\begin{split}
&=4[{\brak{-2.52243783-74.744457}}^2\\&\qquad-5970.1731211]
\end{split}\\
...
And the solution is \begin{align}k=\frac{-\sbrak{2\vec{m}^{\top}\brak{\vec{B}-\vec{I}}}}{2{\ \norm{\vec{m}}^2}}\end{align}
...
So on substituting this value in (8), we get the point $\vec{D_{3}}$ 
\begin{align}
