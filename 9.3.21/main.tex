...
\begin{table}[h!]
 \begin{center}
    ...
    \hline
    $X$ & $1\leq X \leq 12$
    & k defective elements out of 12\\
    \hline
    \end{tabular}
    \end{center}
    \caption{Table 1}
...
\end{table}
    ...
    The $X$ is the random variable, the pmf of $X$ is given by
    \begin{align}
...
&=1.6109(10^{-7})
\end{align}
Hence we observe that the gaussian and binomial distribution perform almost same probability.
\begin{figure}
\centering
