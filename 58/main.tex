...
\end{align}
\begin{align}
\vec{y}=X\mtx{\boldsymbol{\alpha}}+\mtx{\epsilon}
\end{align}
Here the variable $y_i$ is distributed as \begin{align}y_i \sim \gauss{x_i{\boldsymbol{\alpha}}^T}{\sigma^2}\end{align}
The maximum likelihood function can be written as:
\begin{align}
L\brak{\boldsymbol{\alpha},\mu}&=\frac{1}{{(2\pi)}^{\frac{n}{2}}}e^{\frac{-{(\vec{y}-X\mtx{\boldsymbol{\alpha}})}^T(\vec{y}-X\mtx{\boldsymbol{\alpha}})}{2}}\\
ln L\brak{\boldsymbol{\alpha},\mu}&=-\frac{n}{2}ln(2\pi)-\frac{1}{2}{(\vec{y}-X\mtx{\boldsymbol{\alpha}})}^T(\vec{y}-X\mtx{\boldsymbol{\alpha}})
\end{align}
To find the maximum log likelihood
\begin{align}
\frac{\partial lnL\brak{\mtx{\boldsymbol{\alpha}}}}{\partial \mtx{\boldsymbol{\alpha}}}&={X}^TX\boldsymbol{\alpha}-{X}^T\vec{y}\\
&=0\\
{X}^TX\mtx{\boldsymbol{\alpha}}&={X}^T\vec{y}\\
\boldsymbol{\hat{\alpha}} &= (\mathbf{X}^T\mathbf{X})^{-1}\mathbf{X}^T\mathbf{y}
\end{align}
