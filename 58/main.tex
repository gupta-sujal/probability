...
\end{bmatrix}
\end{align}
The covariance matrix for ${\boldsymbol{\epsilon}}$ is:
\begin{align}
 \mathbf{C_{\boldsymbol{\epsilon}}}&=\mathbf{E[({\boldsymbol{\epsilon}}-E{\boldsymbol{\epsilon}})({\boldsymbol{\epsilon}}-E{\boldsymbol{\epsilon}})^{T}]} \\
&= E \begin{bmatrix}
({\epsilon}_1-E\brak{{\epsilon}_1})^2 & ({\epsilon}_1-E\brak{{\epsilon}_1})({\epsilon}_2-E\brak{{\epsilon}_2}) & ... & ({\epsilon}_1-E\brak{{\epsilon}_1})({\epsilon}_n-E\brak{{\epsilon}_n}) \\
({\epsilon}_2-E\brak{{\epsilon}_2})({\epsilon}_1-E\brak{{\epsilon}_1}) & ({\epsilon}_2-E\brak{{\epsilon}_2})^2 & ... & ({\epsilon}_2-E\brak{{\epsilon}_2}) ({\epsilon}_n-E\brak{{\epsilon}_n}) \\
. & . & . & .\\
. & . & . & . \\
. & . & . & . \\
({\epsilon}_n-E\brak{{\epsilon}_n}) ({\epsilon}_1-E\brak{{\epsilon}_1}) & ({\epsilon}_n-E\brak{{\epsilon}_n}) ({\epsilon}_2-E\brak{{\epsilon}_2}) & ... & ({\epsilon}_n-E\brak{{\epsilon}_n})^2\\
\end{bmatrix} \\ 
 &= \begin{bmatrix}
...
Hence, 
\begin{align}
\mathbf{C_{\boldsymbol{\epsilon}}}&=I_{n\times n}
\end{align}
\begin{align}
...
\end{align}
\begin{align}
f\brak{\vec{y}}= \frac{1}{\sqrt{ (2\pi)^n \det(\Sigma)}} \exp {-\dfrac12 ({\vec{y}-\boldsymbol{\mu}})^T\Sigma^{-1}{({\vec{y}-\boldsymbol{\mu}})}}
\end{align}
where $\Sigma $ is the covariance matrix for $\vec{y}$, and $\boldsymbol{\mu}$ is the expectance vector for $\vec{y}$
\begin{align}
f\brak{\vec{y}}= \frac{1}{\sqrt{ (2\pi)^n}} \exp {-\dfrac12 ({\boldsymbol{\epsilon}-E(\boldsymbol{\epsilon})})^T({\boldsymbol{\epsilon}-E(\boldsymbol{\epsilon})})}
\end{align}
...
\begin{align}
L\brak{\boldsymbol{\epsilon}}&=\frac{1}{{(2\pi)}^{\frac{n}{2}}}e^{-\frac{({\boldsymbol{\epsilon}-E(\boldsymbol{\epsilon})})^T({\boldsymbol{\epsilon}-E(\boldsymbol{\epsilon})})}{2}}\\
ln L\brak{\boldsymbol{\epsilon}}&=-\frac{n}{2}ln(2\pi)-\frac{({\boldsymbol{\epsilon}-E(\boldsymbol{\epsilon})})^T({\boldsymbol{\epsilon}-E(\boldsymbol{\epsilon})})}{2}
\end{align}
