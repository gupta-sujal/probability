...
\hhline{|---|}
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 ...
	 \gnumericPB{\centering}\gnumbox{vector $A$}}}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	 \multirow{1}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 \gnumericPB{\centering}\gnumbox{vector $B$}}}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	{\setlength{\gnumericMultiRowLength}{0pt}%
	 \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	 \multirow{1}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 \gnumericPB{\centering}\gnumbox{vector $C$}}}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\vec{A},\vec{B},\vec{C}$ collinearity}}
	&\multicolumn{1}{p{\gnumericColB}|}%
...
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\vec{n^T}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
