...
\solution
Let the event of getting a head on one coin toss be A. Then \begin{align}P(A)=\frac{1}{2}\end{align} The possible outcomes if a coin is tossed two times is \begin{align}
