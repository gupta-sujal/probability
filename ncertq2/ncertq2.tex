...
\solution
Let the event of getting a head on one coin toss be A. Then \begin{align}\pr{A}=\frac{1}{2}\end{align} The possible outcomes if a coin is tossed two times is \begin{align}
S=\cbrak{\brak{HH},\brak{HT},\brak{TH},\brak{TT}}
\end{align}
Let E be the event of getting atmost one head.
\begin{align}
E&=\cbrak{\brak{HT},\brak{TH},\brak{TT}}\\
n(E)&=3
\end{align}
