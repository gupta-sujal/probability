...
$X_1$ & Result of first coin & $X_1$\\\hline
$X_2$ & Result of second coin & $X_2$\\\hline
...
&= \comb{2}{k}(0.5)^2 
\end{align}
where $k \in [0,2]$ The above equation gives the PMF of getting k heads on 2 coint tosses. Let $F_X(k)$ denote the cumulative distribution function of $X$:
\begin{align}
F_X(k) &= p(X \leq k)\\
