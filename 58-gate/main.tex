...
\begin{align}
 ...
 \end{align}
\begin{align}
\vec{y} \sim \gauss{\vec{A}\vec{a}+E({\boldsymbol{\epsilon}})}{I}
\end{align}
\begin{align}
p_{\vec{y}}= \frac{1}{\sqrt{ (2\pi)^n \det( \mathbf{C_{\vec{y}}})}} \exp {-\dfrac12 ({\vec{y}-{\boldsymbol{\mu}}}_{Y})^T{ \mathbf{C_{\vec{y}}}}^{-1}{({\vec{y}-{\boldsymbol{\mu}}_{Y}})}}
\end{align}
where $ \mathbf{C_{\vec{y}}} $ is the covariance matrix for $\vec{y}$, and $\boldsymbol{\mu}_{Y}$ is the expectance vector for $\vec{y}$
...
\begin{align}
L\brak{\vec{y}}&=\frac{1}{{(2\pi)}^{\frac{n}{2}}}e^{-\frac{({\vec{y}-{\boldsymbol{\mu}}}_{Y})^T{({\vec{y}-{\boldsymbol{\mu}}_{Y}})}}{2}}\\
\ln L\brak{\vec{y}}&=-\frac{n}{2}\ln(2\pi)-\dfrac12 ({\vec{y}-{\boldsymbol{\mu}}}_{Y})^T{({\vec{y}-{\boldsymbol{\mu}}_{Y}})}
\end{align}
\begin{align}
\frac{\partial \ln L\brak{\vec{y}}}{\partial \vec{a}}&={\vec{A}}^T\vec{A}\vec{a}-{\vec{A}}^T\vec{y}
\end{align}
The normal equation is
\begin{align}
\frac{\partial \ln L\brak{\vec{y}}}{\partial \vec{a}}&=0\\
{\vec{A}}^T\vec{A}\vec{a}&={\vec{A}}^T\vec{y}\\
\vec{a}&=\brak{{\vec{A}}^T\vec{A}}^{-1}{\vec{A}}^T\vec{y}
\end{align}
